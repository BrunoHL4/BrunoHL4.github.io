...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para la persona que cambió mi año:\n\nCuando pienso en las cosas bonitas que pasaron este año, tú estás en la mayoría de ellas, y sin duda, dentro de las mejores.\n\nGracias por estar conmigo este tiempo y dejarme conocerte más, he aprendido muchas cosas junto a ti y espero poder seguir haciéndolo.\n\nTe amo muchísimo, feliz año!`;  } else {    text = decodeURIComponent(text).replace(/\\n/g, '\n');
  }
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-12-22T00:00:00'); 
